  ...
  education: [
    {
      ...
      achievements: [
        "Business Law Focus",
        "Guest speaker at the Graduate Law Students Association",
      ],
    },
    {
      school: "Universidad de Piura, Faculty of Law",
      degree: "Bachelor of Laws (LL.B.)",
      dateRange: "2012",
      achievements: [
        "Graduated in the top five students",
        "Admission award for academic merit",
      ],
    },
  ],
  languages: [
